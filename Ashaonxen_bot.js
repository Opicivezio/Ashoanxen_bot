...
const token = 'NzM3NjI1MTkyNzE2ODI4NzMz.XyAE_g._m6FvSVzXANXdCucBEOm6ekqJZY';
...
client.on('message', (message) => {
  ...
  if(message.content == '!help') {
    ...
    let embed = new Discord.RichEmbed()
      ...
      .setURL('https://www.youtube.com/channel/UCTcuqKBwbWD0r0KXOrlaYxA/featured')
      .setAuthor('Ashaonxen', img, 'https://www.youtube.com/channel/UCTcuqKBwbWD0r0KXOrlaYxA/featured')
      .setThumbnail(img)
      .addBlankField()
      ...
      .addField('Inline field title', 'Some value here', true)
      .addField('Inline field title', 'Some value here', true)
      .addField('Nightmare Musik 크루', 'Eeden(이덴)\n성태07(성태)\nAshaonxen(에션첸)\nDRIP TARKO(타코)')
      .addBlankField()
      .setTimestamp()
      .setFooter('PLAYER가 만듬', img)
